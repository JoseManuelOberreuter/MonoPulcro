...
object MonkeyImageResolver {
    ...
    private val VIKINGO_STATES = listOf(
        R.drawable.mono_vikingo_1,
        R.drawable.mono_vikingo_2,
        R.drawable.mono_vikingo_3,
    )

    private val MAGO_STATES = listOf(
        R.drawable.mono_mago_1,
        R.drawable.mono_mago_2,
        R.drawable.mono_mago_3,
    ...
    private val VAMPIRO_STATES = listOf(
        R.drawable.mono_vampiro_1,
        R.drawable.mono_vampiro_2,
        R.drawable.mono_vampiro_3,
    )

    private val ELEGANTE_STATES = listOf(
    ...
    private val COCINERO_STATES = listOf(
        R.drawable.mono_cocinero_1,
        R.drawable.mono_cocinero_2,
        R.drawable.mono_cocinero_3,
    )

    private val PIRATA_STATES = listOf(
        R.drawable.mono_pirata_1,
        R.drawable.mono_pirata_2,
        R.drawable.mono_pirata_3,
        R.drawable.mono_pirata_4,
    )
    ...
    private val ACCESSORY_STATES = mapOf(
        ...
        "mago"      to MAGO_STATES,
        "lazo"      to LAZO_STATES,
        "vampiro"   to VAMPIRO_STATES,
        "elegante"  to ELEGANTE_STATES,
        "cocinero"  to COCINERO_STATES,
